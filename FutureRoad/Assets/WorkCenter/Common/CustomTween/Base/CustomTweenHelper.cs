...
namespace CustomTween
{
    ...
    {
        public static FloatTween TweenFloat(Func<float>getter,Action<float>setter,float endVal, float duration,TweenUpdateType updateType = TweenUpdateType.Update)
        {
            var tween=new FloatTween(getter,setter,endVal,duration,updateType);
            return tween;
        }
        ...
        public static RotateTween TweenRotate(this Transform t, Vector3 angle,float duration,bool isGlobal=true, TweenUpdateType updateType = TweenUpdateType.Update)
        {
            var rotTween = new RotateTween(t, angle, duration,isGlobal, updateType);
            return rotTween;
        }
        public static RotateTween TweenRotateTo(this Transform t,Quaternion rot,float duration, bool isGlobal = true, TweenUpdateType updateType =TweenUpdateType.Update)
        {
            var rotTween = new RotateTween(t, rot, duration,isGlobal, updateType);
            return rotTween;
        }
