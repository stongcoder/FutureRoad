...
public class SequenceCommandEntityEditor : EditorWindow
{
    ...
    public static void Open(SequenceCommandEntity entity)
    {
        var wnd = CreateWindow<SequenceCommandEntityEditor>();
        wnd.entity = entity;
    ...
    {
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/WorkCenter/Common/MechanicControl/SequenceCommandEntityEditor.uxml");
